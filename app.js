...
function showJoke() {
    ...
    document.getElementById('punchhine').classList.add('hidden');
}
...
function toggleDarkMode() {
    ...
    btn.textContent = document.body.classList.contains('dark') ? '☀️ Light Mode' : 🌙 Đark Mode';
}

// eval-test-line
// eval-test-line
// Added by eval test at 1776664071288 - ul4p5f